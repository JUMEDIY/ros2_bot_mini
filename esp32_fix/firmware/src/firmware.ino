...
{ 
  ...
  display.clear();
    // update display
  display.drawString(0, 5,"IP: " + String(WiFi.localIP().toString().c_str()));
  if( state == AGENT_CONNECTED ){
     display.drawString(0, 15,"micro-ros....OK");
  }else if( (state == AGENT_DISCONNECTED) || (state == WAITING_AGENT)){
     display.drawString(0, 15,"micro-ros....WAIT");  
  }else{
